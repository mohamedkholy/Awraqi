...
import com.dev3mk.awraqi.databinding.FragmentAddItemBinding
...
class AddItemFragment : BaseFragment<FragmentAddItemBinding>(R.layout.fragment_add_item) {
    ...
    override fun addCallbacks() {
        ...
        binding.apply {
            ...
            buyFormEt.doOnTextChanged{ _, _, _, _ ->
                binding.buyFormTextInputLayout.isErrorEnabled = false
            }
        ...
        binding.apply {
            firestoreReference.document(idEt.text.toString()).set(
                PaperItem(
                    ...
                    buyFormUrl = buyFormEt.text.toString()
                )
            )
    ...
    private fun checkFields(): Boolean {
        ...
        binding.apply {
            ...
            if (buyFormEt.text?.isBlank() == null) {
                isFormUrlEmpty = false
                buyFormTextInputLayout.error = "empty field"
            }
            ...
            return isTitleEmpty && isIdEmpty && isAuthorEmpty && isSubjectEmpty && isPagesEmpty && isPriceEmpty && isPdfEmpty && isCoverEmpty && isFormUrlEmpty
        }
