...
import com.dev3mk.awraqi.data.model.PaintData
import com.dev3mk.awraqi.data.model.PathData
import com.dev3mk.awraqi.databinding.FragmentPdfBinding
import com.dev3mk.awraqi.Base.BaseFragment
import com.dev3mk.awraqi.util.CryptoManager
...
class PdfFragment : BaseFragment<FragmentPdfBinding>(R.layout.fragment_pdf) {
    ...
    override fun setup() {
        ...
        loadingPdfJob = CoroutineScope(Dispatchers.IO).launch {
            getDrawings()
            decryptPdf()
            ensureActive() //checks if loading the pdf job is canceled
            loadPdf()
        }
    }
